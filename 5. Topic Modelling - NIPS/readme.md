...
In order to perform LDA, we need to: <br>
1) filter and simplify the dataset for analysis, and 2) preprocess and transform text data into numerical values which our models can consume. <br> 
