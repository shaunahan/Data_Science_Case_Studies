...
* Machine Learning <br>
    ...
    * __Age Prediction Model__: Use three different datasets of the linkedin profile data to predict ages of the users. Preprocessed and merged datasets to select important features, predicted age using linear regression.
   * __Flower Image Prediction__: Flowers Classification using the VGG16 architecture. Used 2936 images of flowers (daisy, dandelion, roses, sunflowers, tulips), and obtained the classification performance of 80% accuracy. <br><br>
    * __Potato Disease Classification__: Built a CNN deep learning model is to classify potato plant images as healthy, early blight or late blight. <br><br>
